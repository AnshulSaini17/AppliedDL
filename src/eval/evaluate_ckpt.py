...
from ..models.whisper_loader import load_whisper_for_inference
...
def evaluate_checkpoint(config_path: str, checkpoint_path: str = None):
    ...
    metrics_path = out_dir / 'finetuned_metrics.csv'
    predictions_path = out_dir / 'finetuned_predictions.jsonl'
    
    # Checkpoint path
    if checkpoint_path is None:
        checkpoint_path = config['paths']['ckpt_dir']
    ...
    model, processor = load_whisper_for_inference(
